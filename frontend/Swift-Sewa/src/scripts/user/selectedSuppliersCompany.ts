  ...
  static selectedSupplierCompany = async () => {
    ...
    function renderContent(response: { companies: Company }) {
      ...
      <div class=" p-2 w-2/3  rounded-lg shadow-md flex   ">
        <div  class="flex flex-col pl-6 bg-orange-50 border border-gray-200 rounded-lg shadow md:flex-row w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
        >
